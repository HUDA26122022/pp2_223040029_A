...
public class FormPembelianGantungan extends JFrame {
    ...
    public FormPembelianGantungan() {
        
        setTitle("From Pemesanan Gantungan");
        setSize(600, 800);
        ...
        cmbKategori = new JComboBox<>(new String[]{"GT 1", "GT 2", "GT 3", "GT 4"});
        
        ButtonGroup bgKondisi = new ButtonGroup();
        rbBaru = new JRadioButton("Love");
        rbBekas = new JRadioButton("Bintang");
        ...
        inputPanel.add(new JLabel("Manik-Manik :"), gbc);
        ...
        btnSimpan.addActionListener(e -> {
            String[] data = {
                ...
                rbBaru.isSelected() ? "Love" : "Bintang",
